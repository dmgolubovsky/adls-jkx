...
copy --from=ardour /build-ardour/ardour/tools/linux_packaging/Ardour-6.5.0-x86_64.tar .
run tar xvf Ardour-6.5.0-x86_64.tar
workdir Ardour-6.5.0-x86_64
...
run cp /usr/lib/x86_64-linux-gnu/gtk-2.0/2.10.0/engines/libpixmap.so /opt/Ardour-6.5.0/lib
run cp /usr/lib/x86_64-linux-gnu/suil-0/libsuil_x11_in_gtk2.so /opt/Ardour-6.5.0/lib
run cp /usr/lib/x86_64-linux-gnu/suil-0/libsuil_qt5_in_gtk2.so /opt/Ardour-6.5.0/lib
